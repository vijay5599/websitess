...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      text: 'Hello! I\'m the SmileCare assistant. I can help you with information about our dental treatments, costs, appointment booking, and clinic timings. How can I help?',
      sender: 'bot',
      timestamp: new Date(),
    },
  ]);
  ...
  return (
    <>
      {isOpen && (
        <div className="fixed bottom-24 right-4 w-80 bg-white rounded-lg shadow-2xl z-40 flex flex-col" style={{ height: '500px' }}>
          <div className="bg-blue-600 p-4 rounded-t-lg flex justify-between items-center">
            <h3 className="text-white font-bold">SmileCare Chat</h3>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 bg-blue-600 hover:bg-blue-700 text-white rounded-full w-16 h-16 flex items-center justify-center shadow-lg z-40 text-2xl transition"
      >
        💬
      </button>
    </>
